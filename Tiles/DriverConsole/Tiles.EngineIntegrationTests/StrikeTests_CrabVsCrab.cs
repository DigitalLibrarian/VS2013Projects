...
namespace Tiles.EngineIntegrationTests
{
    ...
    public class StrikeTests_CrabVsCrab : DfContentTestBase
    {
        ...
        [TestMethod]
        public void CrabVsCrab_TwoSnatchAttacks()
        {
            var attacker = Crab;
            Assert.AreEqual(2, attacker.Body.Moves.Count(x => x.Name.Equals("snatch")));
        }
        ...
        public void CrabVsCrab_SnatchMaterial()
        {
            ...
            var targetBodyPart = defender.Body.Parts.Single(p => p.Name.Equals("left first foot"));
        ...
        public void CrabVsCrab_SnatchesLeg()
        {
            ...
            Assert.AreEqual(1350, layerResult.Damage.CutFraction.Numerator);
